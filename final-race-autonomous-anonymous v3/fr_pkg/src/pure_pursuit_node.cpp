...
private:
    ...
    double speed = 6.7;//6.7;
    double cornerKpCoeff = 2.0;

    bool controlSlow = false;
...
public:
    ...
    PurePursuit(): rclcpp::Node("pure_pursuit_node") {
        ...
        if (sim) {
            ...
            file = "/home/alan/ESE6150/final-race-autonomous-anonymous/raceline_optim/race3_clean_mincurv_v4.csv";
        } else {
            ...
            file = "/home/nvidia/f1tenth_ws/src/final-race-autonomous-anonymous/raceline_optim/race3_clean_mintime_v4_v2.csv";
//            file = "/home/nvidia/f1tenth_ws/src/final-race-autonomous-anonymous/raceline_optim/race3_v6.csv";
        }
...
//	cout << "marker out" << endl;
        ...
        //    cout << "Obstacle: " << goalX_global << goalY_global << endl;
        //    brakeCoeff = 0.5;
        //}
...
//	cout << "Just before publishDriveMsg" << endl;
	...
	if(joy_msg->buttons[6] == 1){
	    this->controlSlow = true;
	}
	else{
	    this->controlSlow = false;
	    ...
	    cout << "Initialize Pos1" << endl;
            pose.pose.pose.position.x = 1.2;
            pose.pose.pose.position.y = 0.35;
	    ...
	    pose.pose.pose.orientation.x = 0.0;
        pose.pose.pose.orientation.y = 0.0;
        pose.pose.pose.orientation.z = -0.98;
        pose.pose.pose.orientation.w = 0.18;
	    ...
	    pose.pose.pose.orientation.x = 0.0;
            pose.pose.pose.orientation.y = 0.0;
            pose.pose.pose.orientation.z = -0.86;
            pose.pose.pose.orientation.w = 0.5;
	    ...
	    pose.pose.pose.orientation.x = 0.0;
            pose.pose.pose.orientation.y = 0.0;
            pose.pose.pose.orientation.z = 0.69;
    ...
    void publishDriveMsg(vector<double> goal, double brakeCoeff){
        ...
        double new_speed = this->speed * brakeCoeff * abs(1 - abs(steeringAngle / 2));
...
//	cout << "Speed: " << new_speed << endl;
        ...
        //opp_drive_msg.drive.steering_angle = 0;
        //opp_drive_msg.drive.speed = 0;
    ...
    {   
        ...
        double obstacle_detection_range = 1.0;               
        double obstacle_detection_angle = M_PI / 9;          
        ...
        for (int i = 0; i < laser_scan_ranges->ranges.size(); i++) {
            ...
            // auto globalObs = this->localToGlobal(x, y, this->carX, this->carY, this->carYaw);
