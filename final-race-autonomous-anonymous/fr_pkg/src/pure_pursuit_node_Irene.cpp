...
private:
    ...
    double lookAheadDistance =2.0;// 1.75;
...
public:
    ...
    PurePursuit(): rclcpp::Node("pure_pursuit_node") {
        ...
        string file = "/home/nvidia/f1tenth_ws/src/final-race-autonomous-anonymous/race3_1.csv";
        initWaypoints(file);
    ...
    void lidar_callback(const sensor_msgs::msg::LaserScan::ConstSharedPtr laser_scan_ranges) 
    {   
        ...
        double obstacle_detection_range = 2.0;               
        double obstacle_detection_angle = M_PI / 3;          
        ...
        for (int i = 0; i < laser_scan_ranges.size(); i++) {
