...
class PreprocessYOLO(object):
    ...
    def process(self, input_image_path, image=None):
        ...
        """
        image_raw, image_resized = self._load_and_resize(input_image_path, image)
        image_preprocessed = self._shuffle_and_normalize(image_resized)
        return image_raw, image_preprocessed

    def _load_and_resize(self, input_image_path, image=None):
